const GameSVG = () => {
    return (
        <svg width="16" height="16" viewBox="0 0 512 512" xmlns="http://www.w3.org/2000/svg" fill="#000000">
            ...
            <g id="SVGRepo_iconCarrier">
                ...
                <line x1="160" y1="176" x2="160" y2="272" style={{ fill: 'none', stroke: '#000000', strokeLinecap: 'round', strokeLinejoin: 'round', strokeWidth: '32px' }}></line>
                <line x1="208" y1="224" x2="112" y2="224" style={{ fill: 'none', stroke: '#000000', strokeLinecap: 'round', strokeLinejoin: 'round', strokeWidth: '32px' }}></line>
            </g>
        </svg>
    )
}
